...
def follow(head, tail):
    ...
    if (-1 <= off_r <= 1 and -1 <= off_c <= 1):
        # touching - don't move
        pass
    elif off_r == 0 or off_c == 0:
        # horizontal/vertical - decrease offset
        t_r = h_r - off_r // 2
        t_c = h_c - off_c // 2
    else:
        # move diagonal
...
print(CRED + "sample1:", solve1(lines_sample1), CEND)  #
print(CGRN + "puzzle:", solve1(lines_puzzle), CEND)  # 6236
print(CRED + "sample:", solve2(lines_sample1), CEND)  #
print(CRED + "sample:", solve2(lines_sample2), CEND)  #
print(CGRN + "puzzle:", solve2(lines_puzzle), CEND)  # wrong 4883, 2191
