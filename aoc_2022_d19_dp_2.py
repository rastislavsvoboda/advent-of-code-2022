        ...
        if not (game_data, t) in memo:
            ...
            for new_robot in [ROB_CLA,ROB_OBS,ROB_GEO]:
                if can_build(COS, game_data, new_robot):
                    ...
                    costs = COS[new_robot]
                    gain_data = (costs[RES_ORE] + new_ore_rob * (t-1),costs[RES_CLA] + new_cla_rob * (t-1),costs[RES_OBS] + new_obs_rob * (t-1),costs[RES_GEO] + new_geo_rob * (t-1), new_ore_rob, new_cla_rob, new_obs_rob, new_geo_rob)
                    ...
                    build_answer = add_data(gain_data, dp(new_game, t-1))
